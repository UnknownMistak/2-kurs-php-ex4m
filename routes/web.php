...
Route::get('/mythings', [ThingController::class, 'myshow'])->middleware('auth');
Route::get('/myrepair', [ThingController::class, 'showrepair'])->middleware('auth');
Route::get('/mywork', [ThingController::class, 'showork'])->middleware('auth');